                ...
                child:SingleChildScrollView(
                  ...
                  children: [
                      ...
                      VxRating(
                        ...
                        onRatingUpdate: (value){},normalColor: textfieldGrey, selectionColor: golden,count:5,
                        maxRating: 5, size: 25, stepInt: true),
                  
                      10.heightBox,
                      "${data['p_price']}".text.color(brownColor).fontFamily(bold).size(18).make(),
                            ...
                            children: [
                             ...
                             Row(
                              children: [
                                ...
                                "${controller.totalPrice.value}".numCurrency.text.color(brownColor).size(16).fontFamily(bold).make(),
                              ],
                             ).box.padding(const EdgeInsets.all(8)).make(),
                            ],
